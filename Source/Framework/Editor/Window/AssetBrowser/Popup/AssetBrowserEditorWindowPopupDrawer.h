...
namespace FWK::Editor
{
    ...
    private:
        ...
        void DrawCreateFolderMenu(const std::filesystem::path& a_targetFolderPath, const bool a_canCreate, AssetBrowserEditorWindow& a_assetBrowserEditorWindow) const;
