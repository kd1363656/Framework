...
namespace FWK::Graphics
{
	...
	public:
		...
		void Load(const std::filesystem::path& a_filePath, Enum::TextureLoadType a_loadType = Enum::TextureLoadType::Auto, Enum::DefaultTextureType a_defaultTextureType = Enum::DefaultTextureType::BaseColor);
