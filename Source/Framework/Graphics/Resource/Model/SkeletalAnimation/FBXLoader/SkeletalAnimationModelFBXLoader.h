...
namespace FWK::Graphics
{
	...
	private:
		...
		bool ExtractModelMeshList(const BoneNodeIndexMap& a_boneNodeIndexMap, const ufbx_node* a_fbxNode, const std::size_t& a_materialIndex, SkeletalAnimationModelRecord::ModelMesh& a_modelMesh);
		...
		bool CollectModelBoneNodes(const ufbx_scene* a_fbxScene, std::vector<const ufbx_node*>& a_modelBoneNodexList) const;
		...
		TypeAlias::Math::Matrix     ConvertUFBXTransformToMatrix     (const ufbx_transform& a_fbxTransform)  const;
