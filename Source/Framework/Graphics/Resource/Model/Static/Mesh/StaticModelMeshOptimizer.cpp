...
bool FWK::Graphics::StaticModelMeshOptimizer::OptimizeStaticModelMesh(StaticModelRecord::ModelMesh& a_modelMesh) const
{
	...
	std::vector<StaticModelRecord::ModelVertex> l_optimizedModelVertexList = {};
