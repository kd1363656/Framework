...
namespace FWK::Graphics
{
	...
	private:
		...
		using PendingStaticModelBatchUploadRecordMap = std::unordered_map<std::wstring, Struct::StaticModelBatchUploadRecord, Converter::DefaultTextureJsonConverter::WStringHash, std::equal_to<>>;
