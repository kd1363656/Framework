...
void FWK::Converter::PipelineStateBaseJsonConverter::Deserialize(const nlohmann::json& a_rootJson, Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	...
	if (const auto& l_json = a_rootJson.value(k_rasterizerDescJsonKey, nlohmann::json{});
		!l_json.is_null())
	{
		DeserializeRasterizerDesc(l_json, a_pipelineStateBase);
	}
	...
	if (const auto& l_json = a_rootJson.value(k_blendDescJsonKey, nlohmann::json{});
		!l_json.is_null())
	{
		DeserializeBlendDesc(l_json, a_pipelineStateBase);
	}
	...
	if (const auto& l_json = a_rootJson.value(k_depthStencilDescJsonKey, nlohmann::json{});
		!l_json.is_null())
	{
		DeserializeDepthStencilDesc(l_json, a_pipelineStateBase);
	}
	...
	if (const auto& l_json = a_rootJson.value(k_rtvFormatListJsonKey, nlohmann::json{});
		!l_json.is_null())
	{
		DeserializeRTVFormatList(l_json, a_pipelineStateBase);
	}
	...
	if (const auto& l_json = a_rootJson.value(k_sampleDescJsonKey, nlohmann::json{});
		!l_json.is_null())
	{
		DeserializeSampleDesc(l_json, a_pipelineStateBase);
	}
	...
	a_pipelineStateBase.SetPrimitiveTopologyType(l_primitiveTopologyType);
	a_pipelineStateBase.SetDSVFormat			(l_dsvFormat);
	a_pipelineStateBase.SetUseRootSignatureType (l_useRootSignatureType);
	a_pipelineStateBase.SetSampleMask		    (l_sampleMask);
}
...
nlohmann::json FWK::Converter::PipelineStateBaseJsonConverter::Serialize(const Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	...
	l_rootJson[k_rasterizerDescJsonKey] = SerializeRasterizerDesc(a_pipelineStateBase);

	// ブレンドデスクのシリアライズ
	l_rootJson[k_blendDescJsonKey] = SerializeBlendDesc(a_pipelineStateBase);

	// 深度バッファデスクのシリアライズ
	l_rootJson[k_depthStencilDescJsonKey] = SerializeDepthStencilDesc(a_pipelineStateBase);

	// RTVフォーマットリストのシリアライズ
	l_rootJson[k_rtvFormatListJsonKey] = SerializeRTVFormatList(a_pipelineStateBase);

	// DSVフォーマトのシリアライズ
	l_rootJson[k_dsvFormatJsonKey] = a_pipelineStateBase.GetVALDSVFormat();
...
void FWK::Converter::PipelineStateBaseJsonConverter::DeserializeRasterizerDesc(const nlohmann::json& a_rootJson, Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	if (a_rootJson.is_null()) { return; }
	...
	a_pipelineStateBase.SetRasterizerDesc(l_rasterizerDesc);
}
void FWK::Converter::PipelineStateBaseJsonConverter::DeserializeBlendDesc(const nlohmann::json& a_rootJson, Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	if (a_rootJson.is_null()) { return; }
	...
	a_pipelineStateBase.SetBlendDesc(l_blendDesc);

}
void FWK::Converter::PipelineStateBaseJsonConverter::DeserializeDepthStencilDesc(const nlohmann::json& a_rootJson, Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	if (a_rootJson.is_null()) { return; }
	...
	a_pipelineStateBase.SetDepthStencilDesc(l_depthStencilDesc);
}
void FWK::Converter::PipelineStateBaseJsonConverter::DeserializeRTVFormatList(const nlohmann::json& a_rootJson, Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	...
	{
		a_pipelineStateBase.AddRTVFormat(l_json.get<DXGI_FORMAT>());
	}
}
void FWK::Converter::PipelineStateBaseJsonConverter::DeserializeSampleDesc(const nlohmann::json& a_rootJson, Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	if (a_rootJson.is_null()) { return; }
	...
	a_pipelineStateBase.SetSampleDesc(l_sampleDesc);
}
void FWK::Converter::PipelineStateBaseJsonConverter::DeserializeDepthStencilOpDesc(const nlohmann::json & a_rootJson, D3D12_DEPTH_STENCILOP_DESC & a_depthStencilOPDesc) const
{
...
nlohmann::json FWK::Converter::PipelineStateBaseJsonConverter::SerializeRasterizerDesc(const Graphics::PipelineStateBase& a_pipelineStateBase) const
{
		  nlohmann::json l_rootJson	      = {};
	const auto&          l_rasterizerDesc = a_pipelineStateBase.GetREFRasterizerDesc();
...
nlohmann::json FWK::Converter::PipelineStateBaseJsonConverter::SerializeBlendDesc(const Graphics::PipelineStateBase& a_pipelineStateBase) const
{
		  nlohmann::json l_rootJson  = {};
	const auto&			 l_blendDesc = a_pipelineStateBase.GetREFBlendDesc();
...
nlohmann::json FWK::Converter::PipelineStateBaseJsonConverter::SerializeDepthStencilDesc(const Graphics::PipelineStateBase& a_pipelineStateBase) const
{
		  nlohmann::json l_rootJson	        = {};
	const auto&			 l_depthStencilDesc = a_pipelineStateBase.GetREFDepthStencilDesc();
...
nlohmann::json FWK::Converter::PipelineStateBaseJsonConverter::SerializeDepthStencilOPDesc(const D3D12_DEPTH_STENCILOP_DESC& a_depthStencilOPDesc) const
{
	nlohmann::json l_rootJson = {};
...
nlohmann::json FWK::Converter::PipelineStateBaseJsonConverter::SerializeRTVFormatList(const Graphics::PipelineStateBase& a_pipelineStateBase) const
{
		  auto  l_rootJsonArray = nlohmann::json::array					 ();
	const auto& l_rtvFormatList = a_pipelineStateBase.GetREFRTVFormatList();
...
nlohmann::json FWK::Converter::PipelineStateBaseJsonConverter::SerializeSampleDesc(const Graphics::PipelineStateBase& a_pipelineStateBase) const
{
	nlohmann::json l_rootJson   = {};
	const auto&	   l_sampleDesc = a_pipelineStateBase.GetREFSampleDesc();
