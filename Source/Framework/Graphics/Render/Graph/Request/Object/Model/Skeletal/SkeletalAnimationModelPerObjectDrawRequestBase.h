...
{
	class SkeletalAnimationModelPerObjectDrawRequestBase : public DrawRequestPerObjectBase
	{
	public:

		 SkeletalAnimationModelPerObjectDrawRequestBase()          = default;
		~SkeletalAnimationModelPerObjectDrawRequestBase() override = default;
	...
	private:
		...
		Utility::SmartPointerVectorArray<std::weak_ptr<Struct::SkeletalAnimationModelPerObjectDrawRequestData>> m_forwardDrawRequestDataSmartPointerVectorArray = {};
		...
		FWK_DEFINE_TYPE_INFO(SkeletalAnimationModelPerObjectDrawRequestBase, DrawRequestPerObjectBase)
	};
}