...
{
	class FinalPresentRenderTargetPassDrawRequest final : public DrawRequestRenderTargetPassBase<Struct::CBFinalPresentRenderTargetPass, Enum::RenderGraphResourceType::FinalColor>
	{
	public:
