...
void FWK::Converter::RotationComponentConstantMouseModeJsonConverter::Deserialize(const nlohmann::json& a_rootJson, RotationComponentConstantMouseMode& a_moveComponentConstantMouseMode) const
{
...
{
	auto l_rootJson = a_moveComponentConstantMouseMode.RotationComponentConstantModeBase::Serialize();

	const auto& l_xAxisRotatableRange = a_moveComponentConstantMouseMode.GetREFXAxisRotatableRange();
